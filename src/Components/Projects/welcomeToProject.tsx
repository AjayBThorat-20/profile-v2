      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fadeIn" style={{ animationDelay: '60ms' }}>
          ...
          <div className="group relative bg-card border-2 border-border/50 hover:border-primary/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden">
            ...
            <div className="relative flex flex-col items-center text-center space-y-4">
              ...
              <div className="relative p-5 bg-blue-500/10 rounded-2xl group-hover:scale-110 transition-transform duration-200">
                ...
                <FaLightbulb className="relative w-10 h-10 text-blue-600 dark:text-blue-400 group-hover:text-white transition-colors duration-200" />
              </div>
          ...
          <div className="group relative bg-card border-2 border-border/50 hover:border-primary/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden">
            ...
            <div className="relative flex flex-col items-center text-center space-y-4">
              ...
              <div className="relative p-5 bg-purple-500/10 rounded-2xl group-hover:scale-110 transition-transform duration-200">
                ...
                <FaCode className="relative w-10 h-10 text-purple-600 dark:text-purple-400 group-hover:text-white transition-colors duration-200" />
              </div>
          ...
          <div className="group relative bg-card border-2 border-border/50 hover:border-primary/50 rounded-2xl p-6 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl overflow-hidden">
            ...
            <div className="relative flex flex-col items-center text-center space-y-4">
              {/* Icon */}
              <div className="relative p-5 bg-orange-500/10 rounded-2xl group-hover:scale-110 transition-transform duration-200">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-600 to-red-600 opacity-0 group-hover:opacity-100 rounded-2xl transition-opacity duration-200"></div>
                <FaRocket className="relative w-10 h-10 text-orange-600 dark:text-orange-400 group-hover:text-white transition-colors duration-200" />
              </div>
              ...
              {/* Decorative Line */}
              <div className="h-1 w-12 bg-gradient-to-r from-orange-600 to-red-600 rounded-full group-hover:w-20 transition-all duration-300"></div>
            </div>
          </div>
        </div>
