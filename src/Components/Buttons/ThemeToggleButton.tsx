...
export default function ThemeToggleButton() {
  ...
  return (
    <button
      ...
      className="relative p-2 rounded-full hover:bg-muted transition-colors duration-150"
    >
      ...
      <FaSun className="absolute inset-0 m-auto w-6 h-6 text-yellow-400 transition-all duration-200 ease-out scale-0 rotate-90 dark:scale-100 dark:rotate-0" />
    </button>
  );
}
