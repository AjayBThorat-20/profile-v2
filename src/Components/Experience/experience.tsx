                      ...
                      <div className="relative space-y-5">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {exp.techStack.split(", ").slice(0, 6).map((tech, idx) => (
                              <span
                                key={idx}
                                className={`px-3 py-1.5 ${colors.badge} rounded-lg text-xs font-semibold border hover:scale-105 transition-transform duration-150 cursor-default`}
                              >
                                {tech}
                              </span>
                            ))}
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-2">
                          <Link
                            ...
                            className={`magnetic group/btn flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r ${colors.from} ${colors.to} text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 active:scale-95 relative overflow-hidden`}
                          >
                            {/* Shimmer effect */}
                          ...
                          <a
                            ...
                            className="group/link inline-flex items-center justify-center gap-2 px-6 py-3 border-2 border-border hover:border-primary/50 bg-card hover:bg-muted rounded-xl font-bold transition-all duration-200 hover:scale-105 active:scale-95"
                          >
